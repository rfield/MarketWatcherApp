...
## Pre-Requisites
To properly run the app, you will need to set up the backend software: the MarketWatcher Server. This application is also meant as a demonstration and is for learning purposes only.
